...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--runner", type=str, required=True, help="The runner to execute"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--dsm_sigma", type=float, default=0.16, help="Sigma for DSM tuning"
    )
    parser.add_argument(
        "--scalability_dim",
        type=int,
        default=10,
        help="Dimension for scalability testing",
    )
    parser.add_argument(
        "--load_path",
        type=str,
    ...
    if args.algo != "":
        new_config.training.algo = args.algo
