...
def parse_args_and_config():
    ...
    parser.add_argument('--save_sampled_images', action='store_true', help='Whether to save sampled images')
    ...
    if not args.test and not args.calculate_fid and not args.save_sampled_images:
...
def main():
    ...
    try:
        ...
        if args.calculate_fid:
            ...
            return 0
        if args.save_sampled_images:
            runner.save_sampled_images()
            return 0
